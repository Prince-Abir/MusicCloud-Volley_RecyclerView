...
public class EnglishSongAdapter extends RecyclerView.Adapter<EnglishSongAdapter.MyViewHolder> {
    ...
    public EnglishSongAdapter(Activity activity, ArrayList<DataSet> list) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        holder.EnglishSongImage.setImageResource(list.get(position).getImageId());
        holder.EnglishSongName.setText(list.get(position).getSongName());
        holder.EnglishSongSingerName.setText(list.get(position).getSingerName());
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ImageView EnglishSongImage;
        TextView EnglishSongName, EnglishSongSingerName;

        public MyViewHolder(@NonNull View itemView) {
            super(itemView);

            EnglishSongImage = itemView.findViewById(R.id.SongImage);
            EnglishSongName = itemView.findViewById(R.id.SongName);
            EnglishSongSingerName = itemView.findViewById(R.id.SingerName);
        }
    }
}
